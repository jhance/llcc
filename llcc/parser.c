...
{
       0,     0,     3,     5,     8,    11,    13,    15,    22,    27,
      32,    35,    37,    41,    44,    46,    51,    53
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      16,     0,    -1,    17,    -1,    17,    19,    -1,    17,    18,
      -1,    19,    -1,    18,    -1,    12,    13,     5,    21,     6,
       4,    -1,    13,     7,     8,    20,    -1,     5,    21,    23,
       6,    -1,    21,    22,    -1,    22,    -1,    10,    13,     4,
      -1,    23,    24,    -1,    24,    -1,    13,     9,    25,     4,
      -1,    20,    -1,    14,    -1
};
...
{
       0,    63,    63,    93,    98,   103,   110,   119,   140,   155,
     183,   184,   187,   197,   198,   201,   208,   216
};
#endif
...
{
  "$end", "error", "$undefined", "TOKEN_COMMA", "TOKEN_SEMICOLON",
  "TOKEN_LBRACE", "TOKEN_RBRACE", "TOKEN_LPAREN", "TOKEN_RPAREN",
  "TOKEN_ASSIGN", "TOKEN_INT", "TOKEN_CHAR", "TOKEN_STRUCT",
  "TOKEN_IDENTIFIER", "TOKEN_LITERAL_INT", "$accept", "root",
  "module_declarations", "struct", "function", "block", "declarations",
  "declaration", "statements", "statement", "expression", 0
};
#endif
...
{
       0,     0,     0,     0,     2,     6,     5,     0,     0,     1,
       4,     3,     0,     0,     0,     0,    11,     0,     8,     0,
       0,    10,     0,    12,     7,     0,    16,     0,    14,     0,
       9,    13,    17,     0,    15
};
...
{
       0,    -9,    -1,    14,     0,   -13,   -13,    10,     8,   -13,
     -13,   -13,     7,    13,     6,     1,   -13,     7,   -13,    16,
      17,   -13,    -5,   -13,   -13,    15,   -13,    -4,   -13,     9,
     -13,   -13,   -13,    18,   -13
};
...
{
      17,    17,    30,    21,     7,    14,     8,    20,    25,    25,
      21,    14,     1,     2,     9,    12,    13,    14,    17,    19,
      23,    24,    34,    32,    29,    10,    11,     0,    22,    31,
       0,     0,    18
};

static const yytype_int8 yycheck[] =
{
       5,     5,     6,    15,    13,    10,     7,     6,    13,    13,
      22,    10,    12,    13,     0,     5,     8,    10,     5,    13,
       4,     4,     4,    14,     9,     4,     4,    -1,    17,    27,
      -1,    -1,    13
};
...
{
       0,    12,    13,    16,    17,    18,    19,    13,     7,     0,
      18,    19,     5,     8,    10,    21,    22,     5,    20,    13,
       6,    22,    21,     4,     4,    13,    20,    23,    24,     9,
       6,    24,    14,    25,     4
};
...
#line 63 "parser.y"
    {
        struct module_body m = (yyvsp[(1) - (1)].module_body_data);
...
#line 93 "parser.y"
    {
        struct module_body m = (yyvsp[(1) - (2)].module_body_data);
        m.functions = list_append(m.functions, (yyvsp[(2) - (2)].function_data));
        (yyval.module_body_data) = m;
    }
    break;
...
#line 98 "parser.y"
    {
        struct module_body m = (yyvsp[(1) - (2)].module_body_data);
        m.structs = list_append(m.structs, (yyvsp[(2) - (2)].struct_data));
        (yyval.module_body_data) = m;
    }
    break;
...
#line 103 "parser.y"
    {
        ...
        m.functions = list_append(m.functions, (yyvsp[(1) - (1)].function_data));
        m.structs = list_new();
        (yyval.module_body_data) = m;
    }
    break;
...
#line 110 "parser.y"
    {
        ...
        m.functions = list_new();
        m.structs = list_new();
        m.structs = list_append(m.structs, (yyvsp[(1) - (1)].struct_data));
        (yyval.module_body_data) = m;
    }
    break;
...
#line 120 "parser.y"
    {
        char *identifier = (yyvsp[(2) - (6)].string_data);
        struct list declarations = (yyvsp[(4) - (6)].list_data);
...
#line 140 "parser.y"
    {
        ...
        f->name = (yyvsp[(1) - (4)].string_data);
        f->block = (yyvsp[(4) - (4)].block_data);
...
#line 155 "parser.y"
    {
        struct llcc_block b;
        struct list declarations = (yyvsp[(2) - (4)].list_data);
        struct list statements = (yyvsp[(3) - (4)].list_data);
        size_t i;
...
/* Line 1464 of yacc.c  */
#line 183 "parser.y"
    { (yyval.list_data) = list_append((yyvsp[(1) - (2)].list_data), (yyvsp[(2) - (2)].declaration_data)); }
    break;
...
/* Line 1464 of yacc.c  */
#line 184 "parser.y"
    { (yyval.list_data) = list_new(); (yyval.list_data) = list_append((yyval.list_data), (yyvsp[(1) - (1)].declaration_data)); }
    break;
...
#line 187 "parser.y"
    {
        ...
        d->identifier = (yyvsp[(2) - (3)].string_data);

        (yyval.declaration_data) = d;
    }
    break;
...
/* Line 1464 of yacc.c  */
#line 197 "parser.y"
    { (yyval.list_data) = list_append((yyvsp[(1) - (2)].list_data), (yyvsp[(2) - (2)].statement_data)); }
    break;
...
/* Line 1464 of yacc.c  */
#line 198 "parser.y"
    { (yyval.list_data) = list_new(); (yyval.list_data) = list_append((yyval.list_data), (yyvsp[(1) - (1)].statement_data)); }
    break;
...
#line 201 "parser.y"
    {
        ...
        st->data.assign_data.identifier = (yyvsp[(1) - (4)].string_data);
        st->data.assign_data.expr = (yyvsp[(3) - (4)].expr_data);
        (yyval.statement_data) = st;
    }
    break;
...
#line 208 "parser.y"
    {
        ...
        st->data.block_data = (yyvsp[(1) - (1)].block_data);
        (yyval.statement_data) = st;
    }
    break;
...
#line 216 "parser.y"
    {
        ...
        expr.data.literal_data.data.int_data = (yyvsp[(1) - (1)].int_data);
        (yyval.expr_data) = expr;
    }
    break;
